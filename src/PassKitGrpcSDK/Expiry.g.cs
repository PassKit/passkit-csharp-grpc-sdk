...
namespace PassKitGrpcSDK {
    ...
    static ExpiryReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "EkVYUElSRV9TRVRfVE9fTlVMTBAEQkkKEGNvbS5wYXNza2l0LmdycGNaJHN0",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::PassKitGrpcSDK.ExpiryType), }, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::PassKitGrpcSDK.ExpirySettings), global::PassKitGrpcSDK.ExpirySettings.Parser, new[]{ "ExpiryType", "FixedExpiryDate", "ExpireAfterXDays" }, new[]{ "ExpiryOneof" }, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::PassKitGrpcSDK.ExpiryReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private global::PassKitGrpcSDK.ExpiryType expiryType_ = global::PassKitGrpcSDK.ExpiryType.ExpireNone;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PassKitGrpcSDK.ExpiryType ExpiryType {
    ...
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PassKitGrpcSDK.Date FixedExpiryDate {
      get { return expiryOneofCase_ == ExpiryOneofOneofCase.FixedExpiryDate ? (global::PassKitGrpcSDK.Date) expiryOneof_ : null; }
      set {
        expiryOneof_ = value;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (ExpiryType != global::PassKitGrpcSDK.ExpiryType.ExpireNone) hash ^= ExpiryType.GetHashCode();
    ...
    #else
      if (ExpiryType != global::PassKitGrpcSDK.ExpiryType.ExpireNone) {
    ...
    public void MergeFrom(ExpirySettings other) {
      ...
      if (other.ExpiryType != global::PassKitGrpcSDK.ExpiryType.ExpireNone) {
        ExpiryType = other.ExpiryType;
      }
      switch (other.ExpiryOneofCase) {
        case ExpiryOneofOneofCase.FixedExpiryDate:
          if (FixedExpiryDate == null) {
            FixedExpiryDate = new global::PassKitGrpcSDK.Date();
          }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 8: {
            ExpiryType = (global::PassKitGrpcSDK.ExpiryType) input.ReadEnum();
            break;
          }
          case 18: {
            global::PassKitGrpcSDK.Date subBuilder = new global::PassKitGrpcSDK.Date();
            if (expiryOneofCase_ == ExpiryOneofOneofCase.FixedExpiryDate) {

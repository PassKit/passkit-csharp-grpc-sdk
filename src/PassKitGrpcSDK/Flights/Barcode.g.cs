...
namespace PassKitGrpcSDK.Flights {
    ...
    static BarcodeReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "EgUKAVkQAUJhChhjb20ucGFzc2tpdC5ncnBjLkZsaWdodHNaLHN0YXNoLnBh",
            "c3NraXQuY29tL2lvL21vZGVsL3Nkay9nby9pby9mbGlnaHRzqgIWUGFzc0tp",
            "dEdycGNTREsuRmxpZ2h0c2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::PassKitGrpcSDK.CommonObjectsReflection.Descriptor, global::PassKitGrpcSDK.Gateway.ProtocGenOpenapiv2.Options.AnnotationsReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::PassKitGrpcSDK.Flights.PassengerStatus), typeof(global::PassKitGrpcSDK.Flights.PassengerDescription), typeof(global::PassKitGrpcSDK.Flights.Source), typeof(global::PassKitGrpcSDK.Flights.DocType), typeof(global::PassKitGrpcSDK.Flights.InternationalDocVerification), typeof(global::PassKitGrpcSDK.Flights.IDADIndicator), typeof(global::PassKitGrpcSDK.Flights.SelecteeIndicator), typeof(global::PassKitGrpcSDK.Flights.FastTrack), }, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::PassKitGrpcSDK.Flights.ConditionalItems), global::PassKitGrpcSDK.Flights.ConditionalItems.Parser, new[]{ "PassengerDescription", "CheckInSource", "BoardingPassIssuanceSource", "BoardingPassIssueDate", "DocumentType", "BoardingPassIssuer", "BaggageTagNumber", "SelecteeIndicator", "InternationalDocVerification", "IdadIndicator", "FastTrack" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::PassKitGrpcSDK.Flights.BarcodeReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private global::PassKitGrpcSDK.Flights.PassengerDescription passengerDescription_ = global::PassKitGrpcSDK.Flights.PassengerDescription.Adult;
    /// <summary>
    /// Passenger Status as detailed in IATA PSC Resolution 792 Attachment 'C'. Note: all values other than 0 indicate that the passenger has checked in.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PassKitGrpcSDK.Flights.PassengerDescription PassengerDescription {
    ...
    private global::PassKitGrpcSDK.Flights.Source checkInSource_ = global::PassKitGrpcSDK.Flights.Source.W;
    /// <summary>
    /// Source of checkin as detailed in IATA PSC Resolution 792 Attachment 'C'.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PassKitGrpcSDK.Flights.Source CheckInSource {
    ...
    private global::PassKitGrpcSDK.Flights.Source boardingPassIssuanceSource_ = global::PassKitGrpcSDK.Flights.Source.W;
    /// <summary>
    /// Source of boarding pass issuance as detailed in IATA PSC Resolution 792 Attachment 'C'.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PassKitGrpcSDK.Flights.Source BoardingPassIssuanceSource {
    ...
    private global::PassKitGrpcSDK.Date boardingPassIssueDate_;
    /// <summary>
    /// Date of boarding pass issuance, local to the boarding point.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PassKitGrpcSDK.Date BoardingPassIssueDate {
    ...
    private global::PassKitGrpcSDK.Flights.DocType documentType_ = global::PassKitGrpcSDK.Flights.DocType.B;
    /// <summary>
    /// Document type that the barcode represents.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PassKitGrpcSDK.Flights.DocType DocumentType {
    ...
    private global::PassKitGrpcSDK.Flights.SelecteeIndicator selecteeIndicator_ = global::PassKitGrpcSDK.Flights.SelecteeIndicator.NotSelectee;
    /// <summary>
    /// Passenger security status. Note: in practical terms, this is always likely to be NOT_SELECTEE or TSA_PRECHECK since current DHS Pre-Departure Regulations only allow on-site printing of boarding passes. It is mandatory when US travel is involved.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PassKitGrpcSDK.Flights.SelecteeIndicator SelecteeIndicator {
    ...
    private global::PassKitGrpcSDK.Flights.InternationalDocVerification internationalDocVerification_ = global::PassKitGrpcSDK.Flights.InternationalDocVerification.NotRequired;
    /// <summary>
    /// International Documentation Verification status as detailed in IATA PSC Resolution 792 Attachment 'C'.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PassKitGrpcSDK.Flights.InternationalDocVerification InternationalDocVerification {
    ...
    private global::PassKitGrpcSDK.Flights.IDADIndicator idadIndicator_ = global::PassKitGrpcSDK.Flights.IDADIndicator.None;
    /// <summary>
    /// Industry Discount / Airline Discount codes. See IATA Recommended Practice 1788.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PassKitGrpcSDK.Flights.IDADIndicator IdadIndicator {
    ...
    private global::PassKitGrpcSDK.Flights.FastTrack fastTrack_ = global::PassKitGrpcSDK.Flights.FastTrack.N;
    /// <summary>
    /// Passenger eligibility for Fast-track privileges.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PassKitGrpcSDK.Flights.FastTrack FastTrack {
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (PassengerDescription != global::PassKitGrpcSDK.Flights.PassengerDescription.Adult) hash ^= PassengerDescription.GetHashCode();
      if (CheckInSource != global::PassKitGrpcSDK.Flights.Source.W) hash ^= CheckInSource.GetHashCode();
      if (BoardingPassIssuanceSource != global::PassKitGrpcSDK.Flights.Source.W) hash ^= BoardingPassIssuanceSource.GetHashCode();
      if (boardingPassIssueDate_ != null) hash ^= BoardingPassIssueDate.GetHashCode();
      if (DocumentType != global::PassKitGrpcSDK.Flights.DocType.B) hash ^= DocumentType.GetHashCode();
      if (BoardingPassIssuer.Length != 0) hash ^= BoardingPassIssuer.GetHashCode();
      hash ^= baggageTagNumber_.GetHashCode();
      if (SelecteeIndicator != global::PassKitGrpcSDK.Flights.SelecteeIndicator.NotSelectee) hash ^= SelecteeIndicator.GetHashCode();
      if (InternationalDocVerification != global::PassKitGrpcSDK.Flights.InternationalDocVerification.NotRequired) hash ^= InternationalDocVerification.GetHashCode();
      if (IdadIndicator != global::PassKitGrpcSDK.Flights.IDADIndicator.None) hash ^= IdadIndicator.GetHashCode();
      if (FastTrack != global::PassKitGrpcSDK.Flights.FastTrack.N) hash ^= FastTrack.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
    ...
    #else
      if (PassengerDescription != global::PassKitGrpcSDK.Flights.PassengerDescription.Adult) {
        output.WriteRawTag(8);
        output.WriteEnum((int) PassengerDescription);
      }
      if (CheckInSource != global::PassKitGrpcSDK.Flights.Source.W) {
        output.WriteRawTag(16);
        output.WriteEnum((int) CheckInSource);
      }
      if (BoardingPassIssuanceSource != global::PassKitGrpcSDK.Flights.Source.W) {
      ...
      if (DocumentType != global::PassKitGrpcSDK.Flights.DocType.B) {
      ...
      if (SelecteeIndicator != global::PassKitGrpcSDK.Flights.SelecteeIndicator.NotSelectee) {
        output.WriteRawTag(64);
        output.WriteEnum((int) SelecteeIndicator);
      }
      if (InternationalDocVerification != global::PassKitGrpcSDK.Flights.InternationalDocVerification.NotRequired) {
        output.WriteRawTag(72);
        output.WriteEnum((int) InternationalDocVerification);
      }
      if (IdadIndicator != global::PassKitGrpcSDK.Flights.IDADIndicator.None) {
        output.WriteRawTag(80);
        output.WriteEnum((int) IdadIndicator);
      }
      if (FastTrack != global::PassKitGrpcSDK.Flights.FastTrack.N) {
    ...
    public void MergeFrom(ConditionalItems other) {
      ...
      if (other.PassengerDescription != global::PassKitGrpcSDK.Flights.PassengerDescription.Adult) {
        PassengerDescription = other.PassengerDescription;
      }
      if (other.CheckInSource != global::PassKitGrpcSDK.Flights.Source.W) {
        CheckInSource = other.CheckInSource;
      }
      if (other.BoardingPassIssuanceSource != global::PassKitGrpcSDK.Flights.Source.W) {
        BoardingPassIssuanceSource = other.BoardingPassIssuanceSource;
      }
      if (other.boardingPassIssueDate_ != null) {
        if (boardingPassIssueDate_ == null) {
          BoardingPassIssueDate = new global::PassKitGrpcSDK.Date();
        }
        BoardingPassIssueDate.MergeFrom(other.BoardingPassIssueDate);
      }
      if (other.DocumentType != global::PassKitGrpcSDK.Flights.DocType.B) {
      ...
      if (other.SelecteeIndicator != global::PassKitGrpcSDK.Flights.SelecteeIndicator.NotSelectee) {
        SelecteeIndicator = other.SelecteeIndicator;
      }
      if (other.InternationalDocVerification != global::PassKitGrpcSDK.Flights.InternationalDocVerification.NotRequired) {
        InternationalDocVerification = other.InternationalDocVerification;
      }
      if (other.IdadIndicator != global::PassKitGrpcSDK.Flights.IDADIndicator.None) {
        IdadIndicator = other.IdadIndicator;
      }
      if (other.FastTrack != global::PassKitGrpcSDK.Flights.FastTrack.N) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 8: {
            PassengerDescription = (global::PassKitGrpcSDK.Flights.PassengerDescription) input.ReadEnum();
            break;
          }
          case 16: {
            CheckInSource = (global::PassKitGrpcSDK.Flights.Source) input.ReadEnum();
            break;
          }
          case 24: {
            BoardingPassIssuanceSource = (global::PassKitGrpcSDK.Flights.Source) input.ReadEnum();
            break;
          }
          case 34: {
            if (boardingPassIssueDate_ == null) {
          ...
          case 40: {
            DocumentType = (global::PassKitGrpcSDK.Flights.DocType) input.ReadEnum();
            break;
          }
          case 50: {
          ...
          case 64: {
            SelecteeIndicator = (global::PassKitGrpcSDK.Flights.SelecteeIndicator) input.ReadEnum();
            break;
          }
          case 72: {
            InternationalDocVerification = (global::PassKitGrpcSDK.Flights.InternationalDocVerification) input.ReadEnum();
            break;
          }
          case 80: {
            IdadIndicator = (global::PassKitGrpcSDK.Flights.IDADIndicator) input.ReadEnum();
            break;
          }
          case 88: {
            FastTrack = (global::PassKitGrpcSDK.Flights.FastTrack) input.ReadEnum();
            break;
          }
        }
      }

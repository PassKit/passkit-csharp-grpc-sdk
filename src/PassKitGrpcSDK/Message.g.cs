...
namespace PassKitGrpcSDK {
    ...
    static MessageReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "UlMQBUJJChBjb20ucGFzc2tpdC5ncnBjWiRzdGFzaC5wYXNza2l0LmNvbS9p",
            "by9tb2RlbC9zZGsvZ28vaW+qAg5QYXNzS2l0R3JwY1NES2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::PassKitGrpcSDK.LocalizationReflection.Descriptor, global::PassKitGrpcSDK.PaginationReflection.Descriptor, global::Google.Protobuf.WellKnownTypes.TimestampReflection.Descriptor, global::PassKitGrpcSDK.ProtocolsReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::PassKitGrpcSDK.MessageStatus), }, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::PassKitGrpcSDK.Message), global::PassKitGrpcSDK.Message.Parser, new[]{ "Protocol", "CompanyId", "ClassId", "Uuid", "Status", "Warning", "ImageId", "Title", "LocalizedTitle", "Content", "LocalizedContent", "StartDate", "EndDate", "Filter", "RecordsMatchingSegment", "RecordsSuccessfullyUpdate", "RecordsFailedToUpdate", "Created" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::PassKitGrpcSDK.MessageReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private global::PassKitGrpcSDK.MessageStatus status_ = global::PassKitGrpcSDK.MessageStatus.Created;
    /// <summary>
    /// the status of the message.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PassKitGrpcSDK.MessageStatus Status {
      get { return status_; }
      set {
        status_ = value;
      }
    ...
    public override int GetHashCode() {
      ...
      if (Status != global::PassKitGrpcSDK.MessageStatus.Created) hash ^= Status.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (Status != global::PassKitGrpcSDK.MessageStatus.Created) {
    ...
    public void MergeFrom(Message other) {
      ...
      if (other.Status != global::PassKitGrpcSDK.MessageStatus.Created) {
        Status = other.Status;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 40: {
            Status = (global::PassKitGrpcSDK.MessageStatus) input.ReadEnum();
            break;
          }
          case 50: {

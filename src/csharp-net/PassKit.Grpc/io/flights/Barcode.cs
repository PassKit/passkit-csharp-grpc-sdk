...
namespace PassKit.Grpc.DotNet.Flights {
    ...
    static BarcodeReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ZSKFBAoKRmxpZ2h0VVJMcxISCgp1cGdyYWRlVVJMGAEgASgJEhQKDG9yZGVy",
            "Rm9vZFVSTBgCIAEoCRIXCg9wdXJjaGFzZVdpZmlVUkwYAyABKAkSFQoNY2hh",
            "bmdlU2VhdFVSTBgEIAEoCRIYChBlbnRlcnRhaW5tZW50VVJMGAUgASgJEhQK",
            "DGJhZ1BvbGljeVVSTBgGIAEoCRIkChxwdXJjaGFzZUFkZGl0aW9uYWxCYWdn",
            "YWdlVVJMGAcgASgJEh8KF3B1cmNoYXNlTG91bmdlQWNjZXNzVVJMGAggASgJ",
            "EhgKEHJlcG9ydExvc3RCYWdVUkwYCSABKAkSFQoNbWFuYWdlbWVudFVSTBgK",
            "IAEoCRIcChRyZXF1ZXN0V2hlZWxjaGFpclVSTBgLIAEoCRIgChhyZWdpc3Rl",
            "clNlcnZpY2VBbmltYWxVUkwYDCABKAkSHAoUdHJhbnNpdFByb3ZpZGVyRW1h",
            "aWwYDSABKAkSIQoZdHJhbnNpdFByb3ZpZGVyV2Vic2l0ZVVSTBgOIAEoCRIi",
            "Chp0cmFuc2l0UHJvdmlkZXJQaG9uZU51bWJlchgPIAEoCRIYChBhY2Nlc3Np",
            "YmlsaXR5VVJMGBAgASgJEh4KFmJ1c2luZXNzQ2hhdElkZW50aWZpZXIYESAB",
            "KAkSFgoOc3RhbmRieUxpc3RVUkwYEiABKAkq7wIKD1Bhc3NlbmdlclN0YXR1",
            "cxIZChVJU1NVRURfTk9UX0NIRUNLRURfSU4QABIVChFJU1NVRURfQ0hFQ0tF",
            "RF9JThABEiwKKEJBR0dBR0VfQ0hFQ0tFRF9QQVNTRU5HRVJfTk9UX0NIRUNL",
            "RURfSU4QAhIoCiRCQUdHQUdFX0NIRUNLRURfUEFTU0VOR0VSX0NIRUNLRURf",
            "SU4QAxIjCh9QQVNTRU5HRVJfUEFTU0VEX1NFQ1VSSVRZX0NIRUNLEAQSGQoV",
            "UEFTU0VOR0VSX1BBU1NFRF9HQVRFEAUSCwoHVFJBTlNJVBAGEgsKB1NUQU5E",
            "QlkQBxIjCh9CT0FSRElOR19EQVRBX1JFVkFMSURBVElPTl9ET05FEAgSMgou",
            "T1JJR0lOQUxfQk9BUkRJTkdfTElORV9VU0VEX0FUX1RJQ0tFVF9JU1NVQU5D",
            "RRAJEh8KG1VQX09SX0RPV05fR1JBRElOR19SRVFVSVJFRBAKKpABChRQYXNz",
            "ZW5nZXJEZXNjcmlwdGlvbhIJCgVBRFVMVBAAEggKBE1BTEUQARIKCgZGRU1B",
            "TEUQAhIJCgVDSElMRBADEgoKBklORkFOVBAEEhAKDE5PX1BBU1NFTkdFUhAF",
            "EhUKEUFEVUxUX1dJVEhfSU5GQU5UEAYSFwoTVU5BQ0NPTVBBTklFRF9NSU5P",
            "UhAHKkAKBlNvdXJjZRIFCgFXEAASBQoBSxABEgUKAVgQAhIFCgFSEAMSBQoB",
            "TRAEEgUKAU8QBRIFCgFUEAYSBQoBVhAHKhcKB0RvY1R5cGUSBQoBQhAAEgUK",
            "AUkQASpNChxJbnRlcm5hdGlvbmFsRG9jVmVyaWZpY2F0aW9uEhAKDE5PVF9S",
            "RVFVSVJFRBAAEgwKCFJFUVVJUkVEEAESDQoJQ09NUExFVEVEEAIqqwEKDUlE",
            "QURJbmRpY2F0b3ISCAoETk9ORRAAEggKBElETjEQARIICgRJRE4yEAISCAoE",
            "SURCMRADEggKBElEQjIQBBIGCgJBRBAFEgYKAkRHEAYSBgoCRE0QBxIGCgJH",
            "RRAIEgYKAklHEAkSBgoCUkcQChIGCgJVRBALEgYKAklEEAwSCQoFSURGUzEQ",
            "DRIJCgVJREZTMhAOEggKBElEUjEQDxIICgRJRFIyEBAqRQoRU2VsZWN0ZWVJ",
            "bmRpY2F0b3ISEAoMTk9UX1NFTEVDVEVFEAASDAoIU0VMRUNURUUQARIQCgxU",
            "U0FfUFJFQ0hFQ0sQAyoZCglGYXN0VHJhY2sSBQoBThAAEgUKAVkQASqeAQoX",
            "QWlycG9ydFNlY3VyaXR5UHJvZ3JhbXMSGAoUTk9fU0VDVVJJVFlfUFJPR1JB",
            "TVMQABIRCg1UU0FfUFJFX0NIRUNLEAESHgoaVFNBX1BSRV9DSEVDS19UT1VD",
            "SExFU1NfSUQQAhIHCgNPU1MQAxIHCgNJVEkQBBIHCgNJVEQQBRIQCgxHTE9C",
            "QUxfRU5UUlkQBhIJCgVDTEVBUhAHKvoBCgxGbGlnaHRTdGF0dXMSCwoHVU5L",
            "Tk9XThAAEg0KCVNDSEVEVUxFRBABEgwKCERFUEFSVEVEEAISCQoFSU5BSVIQ",
            "AxIKCgZMQU5ERUQQBBILCgdBUlJJVkVEEAUSDQoJQ0FOQ0VMTEVEEAYSCwoH",
            "REVMQVlFRBAHEhUKEURFUEFSVEVEX0RJVkVSVEVEEAgSEgoOSU5BSVJfRElW",
            "RVJURUQQCRIUChBBUlJJVkVEX0RJVkVSVEVEEAoSFQoRREVQQVJURURfUkVD",
            "T1ZFUlkQCxISCg5JTkFJUl9SRUNPVkVSWRAMEhQKEEFSUklWRURfUkVDT1ZF",
            "UlkQDSo9ChBGbGlnaHRDcmVhdGVNb2RlEg4KCkRPX05PVF9VU0UQABIKCgZN",
            "QU5VQUwQARINCglBVVRPTUFUSUMQAiqpAQoMRmxpZ2h0QWxlcnRzEg0KCU5P",
            "X0FMRVJUUxAAEg4KCkFMTF9BTEVSVFMQARIYChRERVBBUlRVUkVfR0FURV9B",
            "TEVSVBACEhgKFERFUEFSVFVSRV9USU1FX0FMRVJUEAQSFgoSQVJSSVZBTF9H",
            "QVRFX0FMRVJUEAgSFgoSQVJSSVZBTF9USU1FX0FMRVJUEBASFgoSQkFHR0FH",
            "RV9CRUxUX0FMRVJUECAqbQoOQm9hcmRpbmdQb2xpY3kSHwobQk9BUkRJTkdf",
            "UE9MSUNZX1VOU1BFQ0lGSUVEEAASDgoKWk9ORV9CQVNFRBABEg8KC0dST1VQ",
            "X0JBU0VEEAISGQoVQk9BUkRJTkdfUE9MSUNZX09USEVSEAMqgwEKD1NlYXRD",
            "bGFzc1BvbGljeRIhCh1TRUFUX0NMQVNTX1BPTElDWV9VTlNQRUNJRklFRBAA",
            "Eg8KC0NBQklOX0JBU0VEEAESDwoLQ0xBU1NfQkFTRUQQAhIOCgpUSUVSX0JB",
            "U0VEEAMSGwoXU0VBVF9DTEFTU19QT0xJQ1lfT1RIRVIQBCofCglBdXRob3Jp",
            "dHkSCAoESUFUQRAAEggKBElDQU8QASqaAQoVUGFzc2VuZ2VyQ2FwYWJpbGl0",
            "aWVzEhMKD05PX0NBUEFCSUxJVElFUxAAEhAKDFBSRV9CT0FSRElORxABEhUK",
            "EVBSSU9SSVRZX0JPQVJESU5HEAISDAoIQ0FSUllfT04QAxIRCg1QRVJTT05B",
            "TF9JVEVNEAQSEgoORVhUUkFfQ0FSUllfT04QBRIOCgpMQVBfSU5GQU5UEAZC",
            "ZgoYY29tLnBhc3NraXQuZ3JwYy5GbGlnaHRzWixzdGFzaC5wYXNza2l0LmNv",
            "bS9pby9tb2RlbC9zZGsvZ28vaW8vZmxpZ2h0c6oCG1Bhc3NLaXQuR3JwYy5E",
            "b3ROZXQuRmxpZ2h0c2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::PassKit.Grpc.DotNet.CommonObjectsReflection.Descriptor, global::Grpc.Gateway.ProtocGenOpenapiv2.Options.AnnotationsReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::PassKit.Grpc.DotNet.Flights.PassengerStatus), typeof(global::PassKit.Grpc.DotNet.Flights.PassengerDescription), typeof(global::PassKit.Grpc.DotNet.Flights.Source), typeof(global::PassKit.Grpc.DotNet.Flights.DocType), typeof(global::PassKit.Grpc.DotNet.Flights.InternationalDocVerification), typeof(global::PassKit.Grpc.DotNet.Flights.IDADIndicator), typeof(global::PassKit.Grpc.DotNet.Flights.SelecteeIndicator), typeof(global::PassKit.Grpc.DotNet.Flights.FastTrack), typeof(global::PassKit.Grpc.DotNet.Flights.AirportSecurityPrograms), typeof(global::PassKit.Grpc.DotNet.Flights.FlightStatus), typeof(global::PassKit.Grpc.DotNet.Flights.FlightCreateMode), typeof(global::PassKit.Grpc.DotNet.Flights.FlightAlerts), typeof(global::PassKit.Grpc.DotNet.Flights.BoardingPolicy), typeof(global::PassKit.Grpc.DotNet.Flights.SeatClassPolicy), typeof(global::PassKit.Grpc.DotNet.Flights.Authority), typeof(global::PassKit.Grpc.DotNet.Flights.PassengerCapabilities), }, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::PassKit.Grpc.DotNet.Flights.ConditionalItems), global::PassKit.Grpc.DotNet.Flights.ConditionalItems.Parser, new[]{ "PassengerDescription", "CheckInSource", "BoardingPassIssuanceSource", "BoardingPassIssueDate", "DocumentType", "BoardingPassIssuer", "BaggageTagNumber", "SelecteeIndicator", "InternationalDocVerification", "IdadIndicator", "FastTrack" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::PassKit.Grpc.DotNet.Flights.FlightSchedule), global::PassKit.Grpc.DotNet.Flights.FlightSchedule.Parser, new[]{ "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::PassKit.Grpc.DotNet.Flights.FlightTimes), global::PassKit.Grpc.DotNet.Flights.FlightTimes.Parser, new[]{ "ScheduledDepartureTime", "BoardingTime", "GateClosingTime", "ScheduledArrivalTime" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::PassKit.Grpc.DotNet.Flights.FlightURLs), global::PassKit.Grpc.DotNet.Flights.FlightURLs.Parser, new[]{ "UpgradeURL", "OrderFoodURL", "PurchaseWifiURL", "ChangeSeatURL", "EntertainmentURL", "BagPolicyURL", "PurchaseAdditionalBaggageURL", "PurchaseLoungeAccessURL", "ReportLostBagURL", "ManagementURL", "RequestWheelchairURL", "RegisterServiceAnimalURL", "TransitProviderEmail", "TransitProviderWebsiteURL", "TransitProviderPhoneNumber", "AccessibilityURL", "BusinessChatIdentifier", "StandbyListURL" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  public enum AirportSecurityPrograms {
    ...
    /// One Stop Security.
    /// </summary>
    [pbr::OriginalName("OSS")] Oss = 3,
    /// <summary>
    /// International to International.
    /// </summary>
    [pbr::OriginalName("ITI")] Iti = 4,
    /// <summary>
    /// International to Domestic.
    /// </summary>
    [pbr::OriginalName("ITD")] Itd = 5,
    /// <summary>
    /// Global Entry.
    /// </summary>
    [pbr::OriginalName("GLOBAL_ENTRY")] GlobalEntry = 6,
    /// <summary>
    /// CLEAR+.
    /// </summary>
    [pbr::OriginalName("CLEAR")] Clear = 7,
  }
  ...
  public enum PassengerCapabilities {
    ...
    [pbr::OriginalName("EXTRA_CARRY_ON")] ExtraCarryOn = 5,
    [pbr::OriginalName("LAP_INFANT")] LapInfant = 6,
  }
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::PassKit.Grpc.DotNet.Flights.BarcodeReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private global::PassKit.Grpc.DotNet.Flights.PassengerDescription passengerDescription_ = global::PassKit.Grpc.DotNet.Flights.PassengerDescription.Adult;
    /// <summary>
    /// Passenger Status as detailed in IATA PSC Resolution 792 Attachment 'C'. Note: all values other than 0 indicate that the passenger has checked in.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.PassengerDescription PassengerDescription {
    ...
    private global::PassKit.Grpc.DotNet.Flights.Source checkInSource_ = global::PassKit.Grpc.DotNet.Flights.Source.W;
    /// <summary>
    /// Source of checkin as detailed in IATA PSC Resolution 792 Attachment 'C'.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.Source CheckInSource {
    ...
    private global::PassKit.Grpc.DotNet.Flights.Source boardingPassIssuanceSource_ = global::PassKit.Grpc.DotNet.Flights.Source.W;
    /// <summary>
    /// Source of boarding pass issuance as detailed in IATA PSC Resolution 792 Attachment 'C'.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.Source BoardingPassIssuanceSource {
    ...
    private global::PassKit.Grpc.DotNet.Date boardingPassIssueDate_;
    /// <summary>
    /// Date of boarding pass issuance, local to the boarding point.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Date BoardingPassIssueDate {
    ...
    private global::PassKit.Grpc.DotNet.Flights.DocType documentType_ = global::PassKit.Grpc.DotNet.Flights.DocType.B;
    /// <summary>
    /// Document type that the barcode represents.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.DocType DocumentType {
    ...
    private global::PassKit.Grpc.DotNet.Flights.SelecteeIndicator selecteeIndicator_ = global::PassKit.Grpc.DotNet.Flights.SelecteeIndicator.NotSelectee;
    /// <summary>
    /// Passenger security status. Note: in practical terms, this is always likely to be NOT_SELECTEE or TSA_PRECHECK since current DHS Pre-Departure Regulations only allow on-site printing of boarding passes. It is mandatory when US travel is involved.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.SelecteeIndicator SelecteeIndicator {
    ...
    private global::PassKit.Grpc.DotNet.Flights.InternationalDocVerification internationalDocVerification_ = global::PassKit.Grpc.DotNet.Flights.InternationalDocVerification.NotRequired;
    /// <summary>
    /// International Documentation Verification status as detailed in IATA PSC Resolution 792 Attachment 'C'.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.InternationalDocVerification InternationalDocVerification {
    ...
    private global::PassKit.Grpc.DotNet.Flights.IDADIndicator idadIndicator_ = global::PassKit.Grpc.DotNet.Flights.IDADIndicator.None;
    /// <summary>
    /// Industry Discount / Airline Discount codes. See IATA Recommended Practice 1788.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.IDADIndicator IdadIndicator {
    ...
    private global::PassKit.Grpc.DotNet.Flights.FastTrack fastTrack_ = global::PassKit.Grpc.DotNet.Flights.FastTrack.N;
    /// <summary>
    /// Passenger eligibility for Fast-track privileges.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.FastTrack FastTrack {
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (PassengerDescription != global::PassKit.Grpc.DotNet.Flights.PassengerDescription.Adult) hash ^= PassengerDescription.GetHashCode();
      if (CheckInSource != global::PassKit.Grpc.DotNet.Flights.Source.W) hash ^= CheckInSource.GetHashCode();
      if (BoardingPassIssuanceSource != global::PassKit.Grpc.DotNet.Flights.Source.W) hash ^= BoardingPassIssuanceSource.GetHashCode();
      if (boardingPassIssueDate_ != null) hash ^= BoardingPassIssueDate.GetHashCode();
      if (DocumentType != global::PassKit.Grpc.DotNet.Flights.DocType.B) hash ^= DocumentType.GetHashCode();
      if (BoardingPassIssuer.Length != 0) hash ^= BoardingPassIssuer.GetHashCode();
      hash ^= baggageTagNumber_.GetHashCode();
      if (SelecteeIndicator != global::PassKit.Grpc.DotNet.Flights.SelecteeIndicator.NotSelectee) hash ^= SelecteeIndicator.GetHashCode();
      if (InternationalDocVerification != global::PassKit.Grpc.DotNet.Flights.InternationalDocVerification.NotRequired) hash ^= InternationalDocVerification.GetHashCode();
      if (IdadIndicator != global::PassKit.Grpc.DotNet.Flights.IDADIndicator.None) hash ^= IdadIndicator.GetHashCode();
      if (FastTrack != global::PassKit.Grpc.DotNet.Flights.FastTrack.N) hash ^= FastTrack.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
    ...
    #else
      if (PassengerDescription != global::PassKit.Grpc.DotNet.Flights.PassengerDescription.Adult) {
        output.WriteRawTag(8);
        output.WriteEnum((int) PassengerDescription);
      }
      if (CheckInSource != global::PassKit.Grpc.DotNet.Flights.Source.W) {
        output.WriteRawTag(16);
        output.WriteEnum((int) CheckInSource);
      }
      if (BoardingPassIssuanceSource != global::PassKit.Grpc.DotNet.Flights.Source.W) {
      ...
      if (DocumentType != global::PassKit.Grpc.DotNet.Flights.DocType.B) {
      ...
      if (SelecteeIndicator != global::PassKit.Grpc.DotNet.Flights.SelecteeIndicator.NotSelectee) {
        output.WriteRawTag(64);
        output.WriteEnum((int) SelecteeIndicator);
      }
      if (InternationalDocVerification != global::PassKit.Grpc.DotNet.Flights.InternationalDocVerification.NotRequired) {
        output.WriteRawTag(72);
        output.WriteEnum((int) InternationalDocVerification);
      }
      if (IdadIndicator != global::PassKit.Grpc.DotNet.Flights.IDADIndicator.None) {
        output.WriteRawTag(80);
        output.WriteEnum((int) IdadIndicator);
      }
      if (FastTrack != global::PassKit.Grpc.DotNet.Flights.FastTrack.N) {
    ...
    public void MergeFrom(ConditionalItems other) {
      ...
      if (other.PassengerDescription != global::PassKit.Grpc.DotNet.Flights.PassengerDescription.Adult) {
        PassengerDescription = other.PassengerDescription;
      }
      if (other.CheckInSource != global::PassKit.Grpc.DotNet.Flights.Source.W) {
        CheckInSource = other.CheckInSource;
      }
      if (other.BoardingPassIssuanceSource != global::PassKit.Grpc.DotNet.Flights.Source.W) {
        BoardingPassIssuanceSource = other.BoardingPassIssuanceSource;
      }
      if (other.boardingPassIssueDate_ != null) {
        if (boardingPassIssueDate_ == null) {
          BoardingPassIssueDate = new global::PassKit.Grpc.DotNet.Date();
        }
        BoardingPassIssueDate.MergeFrom(other.BoardingPassIssueDate);
      }
      if (other.DocumentType != global::PassKit.Grpc.DotNet.Flights.DocType.B) {
      ...
      if (other.SelecteeIndicator != global::PassKit.Grpc.DotNet.Flights.SelecteeIndicator.NotSelectee) {
        SelecteeIndicator = other.SelecteeIndicator;
      }
      if (other.InternationalDocVerification != global::PassKit.Grpc.DotNet.Flights.InternationalDocVerification.NotRequired) {
        InternationalDocVerification = other.InternationalDocVerification;
      }
      if (other.IdadIndicator != global::PassKit.Grpc.DotNet.Flights.IDADIndicator.None) {
        IdadIndicator = other.IdadIndicator;
      }
      if (other.FastTrack != global::PassKit.Grpc.DotNet.Flights.FastTrack.N) {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          default:
            ...
            break;
          case 8: {
            PassengerDescription = (global::PassKit.Grpc.DotNet.Flights.PassengerDescription) input.ReadEnum();
            break;
          }
          case 16: {
            CheckInSource = (global::PassKit.Grpc.DotNet.Flights.Source) input.ReadEnum();
            break;
          }
          case 24: {
            BoardingPassIssuanceSource = (global::PassKit.Grpc.DotNet.Flights.Source) input.ReadEnum();
            break;
          }
          case 34: {
            if (boardingPassIssueDate_ == null) {
          ...
          case 40: {
            DocumentType = (global::PassKit.Grpc.DotNet.Flights.DocType) input.ReadEnum();
            break;
          }
          case 50: {
          ...
          case 64: {
            SelecteeIndicator = (global::PassKit.Grpc.DotNet.Flights.SelecteeIndicator) input.ReadEnum();
            break;
          }
          case 72: {
            InternationalDocVerification = (global::PassKit.Grpc.DotNet.Flights.InternationalDocVerification) input.ReadEnum();
            break;
          }
          case 80: {
            IdadIndicator = (global::PassKit.Grpc.DotNet.Flights.IDADIndicator) input.ReadEnum();
            break;
          }
          case 88: {
            FastTrack = (global::PassKit.Grpc.DotNet.Flights.FastTrack) input.ReadEnum();
            break;
          }
        }
      }
  ...
  #endif
  {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public static pbr::MessageDescriptor Descriptor {
      get { return global::PassKit.Grpc.DotNet.Flights.BarcodeReflection.Descriptor.MessageTypes[1]; }
    }
    ...
    private global::PassKit.Grpc.DotNet.Flights.FlightTimes monday_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.FlightTimes Monday {
      get { return monday_; }
      set {
        monday_ = value;
      }
    ...
    private global::PassKit.Grpc.DotNet.Flights.FlightTimes tuesday_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.FlightTimes Tuesday {
      get { return tuesday_; }
      set {
        tuesday_ = value;
      }
    ...
    private global::PassKit.Grpc.DotNet.Flights.FlightTimes wednesday_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.FlightTimes Wednesday {
    ...
    private global::PassKit.Grpc.DotNet.Flights.FlightTimes thursday_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.FlightTimes Thursday {
    ...
    private global::PassKit.Grpc.DotNet.Flights.FlightTimes friday_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.FlightTimes Friday {
      get { return friday_; }
      set {
        friday_ = value;
      }
    ...
    private global::PassKit.Grpc.DotNet.Flights.FlightTimes saturday_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.FlightTimes Saturday {
    ...
    private global::PassKit.Grpc.DotNet.Flights.FlightTimes sunday_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Flights.FlightTimes Sunday {
      get { return sunday_; }
      set {
        sunday_ = value;
      }
    ...
    public void MergeFrom(FlightSchedule other) {
      ...
      if (other.monday_ != null) {
        if (monday_ == null) {
          Monday = new global::PassKit.Grpc.DotNet.Flights.FlightTimes();
        }
        Monday.MergeFrom(other.Monday);
      }
      if (other.tuesday_ != null) {
        if (tuesday_ == null) {
          Tuesday = new global::PassKit.Grpc.DotNet.Flights.FlightTimes();
        }
        Tuesday.MergeFrom(other.Tuesday);
      }
      if (other.wednesday_ != null) {
        if (wednesday_ == null) {
          Wednesday = new global::PassKit.Grpc.DotNet.Flights.FlightTimes();
        }
        Wednesday.MergeFrom(other.Wednesday);
      }
      if (other.thursday_ != null) {
        if (thursday_ == null) {
          Thursday = new global::PassKit.Grpc.DotNet.Flights.FlightTimes();
        }
        Thursday.MergeFrom(other.Thursday);
      }
      if (other.friday_ != null) {
        if (friday_ == null) {
          Friday = new global::PassKit.Grpc.DotNet.Flights.FlightTimes();
        }
        Friday.MergeFrom(other.Friday);
      }
      if (other.saturday_ != null) {
        if (saturday_ == null) {
          Saturday = new global::PassKit.Grpc.DotNet.Flights.FlightTimes();
        }
        Saturday.MergeFrom(other.Saturday);
      }
      if (other.sunday_ != null) {
        if (sunday_ == null) {
          Sunday = new global::PassKit.Grpc.DotNet.Flights.FlightTimes();
        }
  ...
  #endif
  {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public static pbr::MessageDescriptor Descriptor {
      get { return global::PassKit.Grpc.DotNet.Flights.BarcodeReflection.Descriptor.MessageTypes[2]; }
    }
    ...
    private global::PassKit.Grpc.DotNet.Time scheduledDepartureTime_;
    /// <summary>
    /// The published departure time.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Time ScheduledDepartureTime {
    ...
    private global::PassKit.Grpc.DotNet.Time boardingTime_;
    /// <summary>
    /// The published boarding time.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Time BoardingTime {
    ...
    private global::PassKit.Grpc.DotNet.Time gateClosingTime_;
    /// <summary>
    /// The point after which passengers will be denied boarding.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Time GateClosingTime {
    ...
    private global::PassKit.Grpc.DotNet.Time scheduledArrivalTime_;
    /// <summary>
    /// The published, scheduled arrival time.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.DotNet.Time ScheduledArrivalTime {
  ...
  #endif
  {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public static pbr::MessageDescriptor Descriptor {
      get { return global::PassKit.Grpc.DotNet.Flights.BarcodeReflection.Descriptor.MessageTypes[3]; }
    }
    ...
    public FlightURLs(FlightURLs other) : this() {
      ...
      businessChatIdentifier_ = other.businessChatIdentifier_;
    ...
    public const int BagPolicyURLFieldNumber = 6;
    ...
    public const int AccessibilityURLFieldNumber = 16;
    private string accessibilityURL_ = "";
    /// <summary>
    /// A URL with information for passengers with accessibility requirements.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    ...
    /// <summary>Field number for the "businessChatIdentifier" field.</summary>
    public const int BusinessChatIdentifierFieldNumber = 17;
    private string businessChatIdentifier_ = "";
    /// <summary>
    /// The Transit Provider's Business Identifier, used to launch Apple Business Chat.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public string BusinessChatIdentifier {
      get { return businessChatIdentifier_; }
      set {
        businessChatIdentifier_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }

    /// <summary>Field number for the "standbyListURL" field.</summary>
    public const int StandbyListURLFieldNumber = 18;
    private string standbyListURL_ = "";
    /// <summary>
    /// A URL that links to the standby list for the passenger's flight.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    ...
    public bool Equals(FlightURLs other) {
      ...
      if (BusinessChatIdentifier != other.BusinessChatIdentifier) return false;
    ...
    public override int GetHashCode() {
      ...
      if (BusinessChatIdentifier.Length != 0) hash ^= BusinessChatIdentifier.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (BusinessChatIdentifier.Length != 0) {
        output.WriteRawTag(138, 1);
        output.WriteString(BusinessChatIdentifier);
      }
    ...
    public int CalculateSize() {
      ...
      if (AccessibilityURL.Length != 0) {
        size += 2 + pb::CodedOutputStream.ComputeStringSize(AccessibilityURL);
      }
      if (BusinessChatIdentifier.Length != 0) {
        size += 2 + pb::CodedOutputStream.ComputeStringSize(BusinessChatIdentifier);
      }
      if (StandbyListURL.Length != 0) {
        size += 2 + pb::CodedOutputStream.ComputeStringSize(StandbyListURL);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
    ...
    public void MergeFrom(FlightURLs other) {
      ...
      if (other.BusinessChatIdentifier.Length != 0) {
        BusinessChatIdentifier = other.BusinessChatIdentifier;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 138: {
            BusinessChatIdentifier = input.ReadString();
            break;
          }
          case 146: {

...
namespace PassKit.Grpc.Members {
    ...
    static MemberEventsReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "TlRfTUVNQkVSX1RJRVJfQ0hBTkdFRBAHQl8KGGNvbS5wYXNza2l0LmdycGMu",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::Google.Protobuf.WellKnownTypes.TimestampReflection.Descriptor, global::PassKit.Grpc.PersonalReflection.Descriptor, global::PassKit.Grpc.Gateway.ProtocGenOpenapiv2.Options.AnnotationsReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::PassKit.Grpc.Members.MemberEvents), }, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::PassKit.Grpc.Members.MemberEvent), global::PassKit.Grpc.Members.MemberEvent.Parser, new[]{ "Id", "Member", "EventType", "Address", "Lat", "Lon", "Alt", "ExternalId", "ExternalUserId", "ExternalDeviceId", "ExternalServiceId", "MetaData", "Notes", "Date", "RetainedUntilDate", "Created" }, null, null, null, new pbr::GeneratedClrTypeInfo[] { null, }),
            new pbr::GeneratedClrTypeInfo(typeof(global::PassKit.Grpc.Members.MemberMininmal), global::PassKit.Grpc.Members.MemberMininmal.Parser, new[]{ "Id", "ExternalId", "GroupingIdentifier", "TierId", "ProgramId", "Person" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::PassKit.Grpc.Members.MemberEventsReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private global::PassKit.Grpc.Members.MemberMininmal member_;
    /// <summary>
    /// Member that the event belongs to. This does not contain the full member details, only the key data.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.Members.MemberMininmal Member {
      get { return member_; }
      set {
        member_ = value;
      }
    ...
    private global::PassKit.Grpc.Members.MemberEvents eventType_ = global::PassKit.Grpc.Members.MemberEvents.EventMemberDoNotUse;
    /// <summary>
    /// Event type.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::PassKit.Grpc.Members.MemberEvents EventType {
    ...
    public override int GetHashCode() {
      ...
      if (EventType != global::PassKit.Grpc.Members.MemberEvents.EventMemberDoNotUse) hash ^= EventType.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (EventType != global::PassKit.Grpc.Members.MemberEvents.EventMemberDoNotUse) {
    ...
    public void MergeFrom(MemberEvent other) {
      ...
      if (other.member_ != null) {
        if (member_ == null) {
          Member = new global::PassKit.Grpc.Members.MemberMininmal();
        }
        Member.MergeFrom(other.Member);
      }
      if (other.EventType != global::PassKit.Grpc.Members.MemberEvents.EventMemberDoNotUse) {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 24: {
            EventType = (global::PassKit.Grpc.Members.MemberEvents) input.ReadEnum();
            break;
          }
          case 34: {
  ...
  #endif
  {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public static pbr::MessageDescriptor Descriptor {
      get { return global::PassKit.Grpc.Members.MemberEventsReflection.Descriptor.MessageTypes[1]; }
    }

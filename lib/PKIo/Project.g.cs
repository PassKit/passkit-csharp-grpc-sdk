...
namespace PKIo {
    ...
    static ProjectReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "GGlvL2NvbW1vbi90ZW1wbGF0ZS5wcm90byKpAQoHUHJvamVjdBIiCghwcm90",
            ...
            "IAEoCRILCgNrZXkYByABKAkiXAoYUHJvamVjdEJ5U2hvcnRDb2RlUmVzdWx0",
            "EhwKB3Byb2plY3QYASABKAsyCy5pby5Qcm9qZWN0EiIKCHRlbXBsYXRlGAIg",
            "ASgLMhAuaW8uUGFzc1RlbXBsYXRlIjgKE1Byb2plY3RTdGF0dXNGaWx0ZXIS",
            "IQoGc3RhdHVzGAEgASgOMhEuaW8uUHJvamVjdFN0YXR1cyrkAQoNUHJvamVj",
            "dFN0YXR1cxIVChFOT19QUk9KRUNUX1NUQVRVUxAAEiYKIlBST0pFQ1RfQUNU",
            "SVZFX0ZPUl9PQkpFQ1RfQ1JFQVRJT04QARIoCiRQUk9KRUNUX0RJU0FCTEVE",
            "X0ZPUl9PQkpFQ1RfQ1JFQVRJT04QAhIRCg1QUk9KRUNUX0RSQUZUEAQSFQoR",
            "UFJPSkVDVF9QVUJMSVNIRUQQCBITCg9QUk9KRUNUX1BSSVZBVEUQEBIWChJQ",
            "Uk9KRUNUX09WRVJfUVVPVEEQIBITCg9QUk9KRUNUX0RFTEVURUQQQEI+Cg9p",
            "by5wYXNza2l0LlBLaW9aJHN0YXNoLnBhc3NraXQuY29tL2lvL21vZGVsL3Nk",
            "ay9nby9pb6oCBFBLSW9iBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::Google.Protobuf.WellKnownTypes.TimestampReflection.Descriptor, global::PKIo.ProtocolsReflection.Descriptor, global::PKIo.TemplateReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::PKIo.ProjectStatus), }, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::PKIo.Project), global::PKIo.Project.Parser, new[]{ "Protocol", "ClassId", "Name", "ShortCode", "Created", "Secret", "Key" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::PKIo.ProjectByShortCodeResult), global::PKIo.ProjectByShortCodeResult.Parser, new[]{ "Project", "Template" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::PKIo.ProjectStatusFilter), global::PKIo.ProjectStatusFilter.Parser, new[]{ "Status" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class Project : pb::IMessage<Project> {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::PKIo.ProjectReflection.Descriptor.MessageTypes[0]; }
    }
  ...
  public sealed partial class ProjectByShortCodeResult : pb::IMessage<ProjectByShortCodeResult> {
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pbr::MessageDescriptor Descriptor {
      get { return global::PKIo.ProjectReflection.Descriptor.MessageTypes[1]; }
    }
    ...
    private global::PKIo.Project project_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PKIo.Project Project {
      get { return project_; }
      set {
        project_ = value;
      }
    ...
    public void MergeFrom(ProjectByShortCodeResult other) {
      ...
      if (other.project_ != null) {
        if (project_ == null) {
          Project = new global::PKIo.Project();
        }
  ...
  public sealed partial class ProjectStatusFilter : pb::IMessage<ProjectStatusFilter> {
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pbr::MessageDescriptor Descriptor {
      get { return global::PKIo.ProjectReflection.Descriptor.MessageTypes[2]; }
    }
    ...
    private global::PKIo.ProjectStatus status_ = global::PKIo.ProjectStatus.NoProjectStatus;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::PKIo.ProjectStatus Status {
      get { return status_; }
      set {
        status_ = value;
      }
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (Status != global::PKIo.ProjectStatus.NoProjectStatus) hash ^= Status.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void WriteTo(pb::CodedOutputStream output) {
      if (Status != global::PKIo.ProjectStatus.NoProjectStatus) {
        output.WriteRawTag(8);
    ...
    public void MergeFrom(ProjectStatusFilter other) {
      ...
      if (other.Status != global::PKIo.ProjectStatus.NoProjectStatus) {
        Status = other.Status;
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 8: {
            Status = (global::PKIo.ProjectStatus) input.ReadEnum();
            break;
          }
        }
      }
